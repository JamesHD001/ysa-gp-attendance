...
let students = JSON.parse(localStorage.getItem("missionPrepStudents")) || [];
...
function renderTable() {
    ...
    students.forEach((student, index) => {
        ...
        row.innerHTML = `
            ...
            <td>
                <select>
                    <option ${student.gender === "--Select Gender--" ? "selected" : ""}>--Select Gender--</option>
...
document.querySelector(".save-btn").addEventListener("click", () => {
    ...
    localStorage.setItem("missionPrepStudents", JSON.stringify(students));
